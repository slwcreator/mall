...
public class OrderServiceImpl implements OrderService {
    ...
    public List<OrderStatisticsVO> statistics(Date startDate, Date endDate) {
        OrderStatisticsQuery statisticsQuery = new OrderStatisticsQuery();
        statisticsQuery.setStartDate(startDate);
        statisticsQuery.setEndDate(endDate);
        return orderMapper.selectOrderStatistics(statisticsQuery);
    }
}
